  ...
  <div class="app-container">
      ...
      <el-col>
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
          <el-form-item label="商户" prop="username">
            <el-input v-model="queryParams.username" placeholder="商户" clearable style="width: 240px"
        ...
        <el-table v-loading="loading" :data="userList">
          ...
          <el-table-column label="评价内容" align="center" key="remark" prop="remark" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="评价等级" align="center" key="email" prop="email" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="评价时间" align="center" prop="createTime" v-if="columns[6].visible" width="240">
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="商户地址" prop="username">
              <el-input v-model="form.username" placeholder="请输入经营地址" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="评价等级" prop="email">
              <el-input v-model="form.email" placeholder="请输入评价等级" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
  ...
  methods: {
    ...
    getList() {
      ...
      listUser(this.queryParams).then(response => {
          ...
          response.data.list[0].email = '4星'
          response.data.list[0].nickname = '蔬菜'
          response.data.list[0].remark = '商铺打扫干净'

          response.data.list[1].username = '东区B2'
          response.data.list[1].email = '4.5星'
          response.data.list[1].nickname = '水果'
          response.data.list[1].remark = '水果种类繁多，新鲜'

          response.data.list[2].username = '南区A1'
          response.data.list[2].email = '5星'
          response.data.list[2].nickname = '淡水水产'
          response.data.list[2].remark = '动作干净，东西实在'

          response.data.list[3].username = '南区B1'
          response.data.list[3].email = '4星'
          response.data.list[3].nickname = '海鲜'
          response.data.list[3].remark = '味道鲜美'

          response.data.list[4].username = '西区A1'
          response.data.list[4].email = '4星'
          response.data.list[4].nickname = '肉类'
          response.data.list[4].remark = '种类齐全'

          response.data.list[5].username = '西区C1'
          response.data.list[5].email = '4.5星'
          response.data.list[5].nickname = '家禽'
          response.data.list[5].remark = '东西很实在'

          response.data.list[6].username = '北区A1'
          response.data.list[6].email = '4星'
          response.data.list[6].nickname = '豆制品'
          response.data.list[6].remark = '东西很新鲜'

          response.data.list[7].username = '北区A2'
          response.data.list[7].email = '3星'
          response.data.list[7].nickname = '干货'
          response.data.list[7].remark = '东西非常好吃'

          response.data.list[8].username = '北区D1'
          response.data.list[8].email = '5星'
          response.data.list[8].nickname = '炒货'
          response.data.list[8].remark = '老板非常热心'
