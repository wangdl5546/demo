  ...
  <div class="app-container">
      ...
      <el-col>
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
          <el-form-item label="商户地址" prop="username">
            <el-input v-model="queryParams.username" placeholder="商户地址" clearable style="width: 240px"
    ...
    <el-dialog :title="title" :visible.sync="open11" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="营业执照" prop="nickname">
              <el-image style="width: 100px; height: 100px" :src="'https://p8.itc.cn/q_70/images03/20201121/bfa9d2cace6740fb9ace776250d6cd0a.jpeg'" :fit="fit" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="健康证" prop="nickname">
              <el-image style="width: 100px; height: 100px" :src="'http://thepaper-prod-oldimagefromnfs.oss-cn-shanghai.aliyuncs.com/image/23/884/633.jpg'" :fit="fit" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
