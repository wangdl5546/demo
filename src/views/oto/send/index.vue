    ...
    <el-row :gutter="20">
      ...
      <el-col>
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
          <el-form-item label="配送单号" prop="username">
            <el-input v-model="queryParams.username" placeholder="请输入用户名称" clearable style="width: 240px"
                      @keyup.enter.native="handleQuery"/>
          </el-form-item>
          <el-form-item label="配送人" prop="mobile">
        ...
        <el-table v-loading="loading" :data="userList">
          <el-table-column label="配送单号" align="center" key="id" prop="id" v-if="columns[0].visible" />
          <el-table-column label="配送人" align="center" key="username" prop="username" v-if="columns[1].visible" :show-overflow-tooltip="true" />
          <el-table-column label="配送商品" align="center" key="nickname" prop="nickname" v-if="columns[2].visible" :show-overflow-tooltip="true" />
          <el-table-column label="配送地点" align="center" key="deptName" prop="dept.name" v-if="columns[3].visible" :show-overflow-tooltip="true" />
          <el-table-column label="配送状态" key="status" v-if="columns[5].visible" align="center">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="配送人" prop="username">
              <el-input v-model="form.username" placeholder="请输入配送人" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="配送商品" prop="nickname">
              <el-input v-model="form.nickname" placeholder="请输入配送商品" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="配送地点" prop="nickname">
              <el-input v-model="form.avatar" placeholder="请输入配送地点" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
