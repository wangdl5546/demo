  ...
  <div class="app-container">
    ...
    <el-row :gutter="30">
      ...
      <el-col>
        ...
        <el-table v-loading="loading" :data="userList">
          ...
          <el-table-column label="姓名" align="center" key="remark" prop="remark" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="身份证" align="center" key="nickname" prop="nickname" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="联系电话" align="center" key="email" prop="email" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="家庭住址" align="center" key="username" prop="username" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="入职时间" align="center" prop="createTime" v-if="columns[6].visible" width="240">
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="身份证" prop="nickname">
              <el-input v-model="form.nickname" placeholder="请输入身份证" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="家庭住址" prop="username">
              <el-input v-model="form.username" placeholder="请输入家庭住址" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
