  ...
  <div class="app-container">
      ...
      <el-col>
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
          <el-form-item label="姓名" prop="username">
            <el-input v-model="queryParams.username" placeholder="姓名" clearable style="width: 240px"
        ...
        <el-table v-loading="loading" :data="userList">
          ...
          <el-table-column label="摊主姓名" align="center" key="username" prop="username" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="摊位地址" align="center" key="nickname" prop="nickname" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="经营种类" align="center" key="email" prop="email" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="摊主姓名" prop="username">
              <el-input v-model="form.username" placeholder="请输入摊主姓名" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="摊位地址" prop="nickname">
              <el-input v-model="form.nickname" placeholder="请输入摊位地址" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="经营种类" prop="email">
              <el-input v-model="form.email" placeholder="请输入经营种类" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
  ...
  methods: {
    ...
    getList() {
      ...
      listUser(this.queryParams).then(response => {
          ...
          response.data.list[0].username = '张三'
          response.data.list[0].email = '水果摊'
          response.data.list[0].nickname = 'A区1排22号摊位'
          response.data.list[0].remark = '合格'

          response.data.list[1].username = '李四'
          response.data.list[1].email = '水果摊'
          response.data.list[1].nickname = 'A区1排25号摊位'
          response.data.list[1].remark = '合格'

          response.data.list[2].username = '王五'
          response.data.list[2].email = '水果摊'
          response.data.list[2].nickname = 'A区1排19号摊位'
          response.data.list[2].remark = '合格'

          response.data.list[3].username = '赵某某'
          response.data.list[3].email = '水果摊'
          response.data.list[3].nickname = 'A区1排20号摊位'
          response.data.list[3].remark = '合格'

          response.data.list[4].username = '王四'
          response.data.list[4].email = '水果摊'
          response.data.list[4].nickname = 'A区1排23号摊位'
          response.data.list[4].remark = '合格'

          response.data.list[5].username = '刘大爷'
          response.data.list[5].email = '水果摊'
          response.data.list[5].nickname = 'A区2排22号摊位'
          response.data.list[5].remark = '合格'

          response.data.list[6].username = '李老三'
          response.data.list[6].email = '水果摊'
          response.data.list[6].nickname = 'B区1排22号摊位'
          response.data.list[6].remark = '合格'

          response.data.list[7].username = '李老三'
          response.data.list[7].email = '水果摊'
          response.data.list[7].nickname = 'B区1排22号摊位'
          response.data.list[7].remark = '合格'

          response.data.list[8].username = '李老三'
          response.data.list[8].email = '水果摊'
          response.data.list[8].nickname = 'B区1排22号摊位'
