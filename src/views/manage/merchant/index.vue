  ...
  <div class="app-container">
    ...
    <el-row :gutter="30">
      ...
      <el-col>
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
          <el-form-item label="经营人" prop="username">
            <el-input v-model="queryParams.username" placeholder="经营人" clearable style="width: 240px"
        ...
        <el-table v-loading="loading" :data="userList">
          <el-table-column label="商户ID" align="center" key="id" prop="id" v-if="columns[0].visible"  width="240"/>
          <el-table-column label="经营地址" align="center" key="username" prop="username" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="经营人" align="center" key="remark" prop="remark" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="经营人" prop="remark">
              <el-input v-model="form.remark" placeholder="请输入经营人" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
