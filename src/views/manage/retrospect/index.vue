    ...
    <el-row :gutter="30">
      ...
      <el-col>
        ...
        <el-table v-loading="loading" :data="userList">
          ...
          <el-table-column label="供应商" align="center" key="remark" prop="remark" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="供应商" prop="remark">
              <el-input v-model="form.remark" placeholder="请输入供应商" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
