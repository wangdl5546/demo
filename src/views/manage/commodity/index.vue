  ...
  <div class="app-container">
    ...
    <el-row :gutter="30">
      ...
      <el-col>
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
          <el-form-item label="商品种类" prop="username">
            <el-input v-model="queryParams.username" placeholder="商品种类" clearable style="width: 240px"
        ...
        <el-table v-loading="loading" :data="userList">
          ...
          <el-table-column label="商品种类" align="center" key="nickname" prop="nickname" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="价格（元/斤）" align="center" key="remark" prop="remark" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="昨日价格（元/斤）" align="center" key="email" prop="email" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="商品种类" prop="nickname">
              <el-input v-model="form.remark" placeholder="请输入商品种类" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="价格（元/斤）" prop="remark">
              <el-input v-model="form.nickname" placeholder="请输入价格（元/斤）" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="昨日价格（元/斤）" prop="email">
              <el-input v-model="form.email" placeholder="请输入昨日价格（元/斤）" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
