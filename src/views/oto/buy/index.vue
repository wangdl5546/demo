  ...
  <div class="app-container">
    <!-- 搜索工作栏 -->
      ...
      <el-col>
        ...
        <el-table v-loading="loading" :data="userList">
          <el-table-column label="预定人" align="center" key="id" prop="id" v-if="columns[0].visible" />
          <el-table-column label="预定商品" align="center" key="username" prop="username" v-if="columns[1].visible" :show-overflow-tooltip="true" />
          <el-table-column label="预定金额" align="center" key="mobile" prop="mobile" v-if="columns[4].visible" width="120" />
          <el-table-column label="预定时间" align="center" prop="createTime" v-if="columns[6].visible" width="160">
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="预定人" prop="id">
              <el-input v-model="form.id" placeholder="请输入预定人" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="预定商品" prop="username">
              <el-input v-model="form.username" placeholder="请输预定商品" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="预定金额" prop="mobile">
              <el-input v-model="form.mobile" placeholder="请输入预定金额" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
