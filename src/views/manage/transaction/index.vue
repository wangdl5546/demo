  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="交易摊位" prop="username">
              <el-input v-model="form.username" placeholder="请输入交易摊位" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="交易商品" prop="nickname">
              <el-input v-model="form.nickname" placeholder="请输入交易商品" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="交易金额" prop="email">
              <el-input v-model="form.email" placeholder="请输入交易金额" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
