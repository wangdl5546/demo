    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList">
          <el-table-column label="设备编码" align="center" key="id" prop="id" v-if="columns[0].visible" />
          ...
          <el-table-column label="设备设备" key="status" v-if="columns[5].visible" align="center">
  ...
  methods: {
    ...
    getList() {
      ...
      listUser(this.queryParams).then(response => {
          ...
          response.data.list[0].username = '大门左侧枪机'
          response.data.list[0].nickname = '大门左侧枪机'
          response.data.list[1].username = '大门右侧枪机'
          response.data.list[1].nickname = '大门右侧枪机'
          response.data.list[2].username = '库房大门云台'
          response.data.list[2].nickname = '库房大门云台'
          response.data.list[3].username = '前台云台'
          response.data.list[3].nickname = '前台云台'
          response.data.list[4].username = '走廊全景'
          response.data.list[4].nickname = '走廊全景'
          response.data.list[5].username = '走廊右侧通道全景'
          response.data.list[5].nickname = '走廊右侧通道全景'
          response.data.list[6].username = '走廊左侧通道全景'
          response.data.list[6].nickname = '走廊左侧通道全景  '
