    ...
    <el-row :gutter="20">
      ...
      <el-col>
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
          <el-form-item label="交易商品" prop="username">
        ...
        <el-table v-loading="loading" :data="userList">
          <el-table-column label="交易商品" align="center" key="id" prop="id" v-if="columns[0].visible" />
          <el-table-column label="支付方式" align="center" key="username" prop="username" v-if="columns[1].visible" :show-overflow-tooltip="true" />
          <el-table-column label="提货方式" align="center" key="nickname" prop="nickname" v-if="columns[2].visible" :show-overflow-tooltip="true" />
          <el-table-column label="交易金额" align="center" key="mobile" prop="mobile" v-if="columns[4].visible" width="120" />
          <el-table-column label="交易时间" align="center" prop="createTime" v-if="columns[6].visible" width="160">
  ...
  methods: {
    ...
    getList() {
      ...
      listUser(this.queryParams).then(response => {
          response.data.list[0].id = '苹果'
          response.data.list[1].id = '香蕉'
          response.data.list[2].id = '西瓜'
          response.data.list[3].id = '葡萄'
          response.data.list[4].id = '甘蔗'
          response.data.list[5].id = '苹果'
          response.data.list[6].id = '苹果'
          response.data.list[7].id = '苹果'
          response.data.list[8].id = '苹果'
          response.data.list[0].username = '网银'
          response.data.list[1].username = '网银'
          response.data.list[2].username = '网银'
          response.data.list[3].username = '网银'
          response.data.list[4].username = '网银'
          response.data.list[5].username = '网银'
          response.data.list[6].username = '网银'
          response.data.list[7].username = '网银'
          response.data.list[8].username = '网银'
          response.data.list[0].nickname = '货运'
          response.data.list[1].nickname = '货运'
          response.data.list[2].nickname = '海运'
          response.data.list[3].nickname = '海运'
          response.data.list[4].nickname = '海运'
          response.data.list[5].nickname = '空运'
          response.data.list[6].nickname = '空运'
          response.data.list[7].nickname = '空运'
          response.data.list[8].nickname = '空运'
