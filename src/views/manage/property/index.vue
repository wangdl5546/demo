      ...
      <el-col>
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
          <el-form-item label="申请人" prop="username">
            <el-input v-model="queryParams.username" placeholder="申请人" clearable style="width: 240px"
        ...
        <el-table v-loading="loading" :data="userList">
          ...
          <el-table-column label="类别" align="center" key="username" prop="username" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="内容" align="center" key="nickname" prop="nickname" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="申请人" align="center" key="remark" prop="remark" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="申请时间" align="center" prop="createTime" v-if="columns[6].visible" width="240">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="申请人" prop="remark">
              <el-input v-model="form.remark" placeholder="请输入申请人" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
  ...
  methods: {
    ...
    getList() {
      ...
      listUser(this.queryParams).then(response => {
          ...
          response.data.list[0].username = '维修申请'
          response.data.list[0].email = '15067110000'
          response.data.list[0].nickname = '商户照明损坏'
          response.data.list[0].remark = '王五'

          response.data.list[1].username = '维修申请'
          response.data.list[1].email = '15067110000'
          response.data.list[1].nickname = '下水道堵死'
          response.data.list[1].remark = '赵六'

          response.data.list[2].username = '维修申请'
          response.data.list[2].email = '15067110000'
          response.data.list[2].nickname = '商户照明损坏'
          response.data.list[2].remark = '犀利'

          response.data.list[3].username = '维修申请'
          response.data.list[3].email = '15067110000'
          response.data.list[3].nickname = '断电'
          response.data.list[3].remark = '梓潼'

          response.data.list[4].username = '维修申请'
          response.data.list[4].email = '15067110000'
          response.data.list[4].nickname = '下水道堵死'
          response.data.list[4].remark = '一辉'

          response.data.list[5].username = '维修申请'
          response.data.list[5].email = '15067220000'
          response.data.list[5].nickname = '断电'
          response.data.list[5].remark = '星耀'

          response.data.list[6].username = '维修申请'
          response.data.list[6].email = '15067330000'
          response.data.list[6].nickname = '下水道堵死'
          response.data.list[6].remark = '小A'

          response.data.list[7].username = '维修申请'
          response.data.list[7].email = '15067440000'
          response.data.list[7].nickname = '商户照明损坏'
          response.data.list[7].remark = '菊琴'

          response.data.list[8].username = '水电费上报'
          response.data.list[8].email = '15067550000'
          response.data.list[8].nickname = '10月电费上报'
